  ...
  <div id="header">
    <div class="box-container header-container row verticle-center pl5 pr5">
      <div class="flex-1 verticle-center">
        <div class="header-logo"><img :src="logoUrl" alt="" /></div>
...
export default {
  ...
  methods: {
    ...
    handleSelect(key, keyPath) {
      ...
      this.$emit('eventTap',{type:'nuxt'});
    },
    // 搜索
    handleSearch() {
      this.$emit('eventTap',{type:'search',searchValue:this.searchValue,curIndex:this.curIndex});
    }
  },
  watch: {
    $route: function() {
